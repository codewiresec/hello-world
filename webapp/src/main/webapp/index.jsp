...
<head> 
    <title>Ocean world Html Code Example Live Demo</title>
    <meta name="Keywords">
...
<script src="//capp.nicepage.com/f6e30d8d24c837fca1c7f22e3dad1c04e8064c67/main-libs.js" ></script>
<link href="//capp.nicepage.com/f6e30d8d24c837fca1c7f22e3dad1c04e8064c67/main-libs.css" rel="stylesheet" />
...
<div class="page-preview">
    <div class="page-preview-header">
        ...
        <a class="close" href="/hc/101327/ocean-world-html-code"><img alt="Close" src="//csite.nicepage.com/Images/Site/icon-close.png"></a>
    </div>
    <div class="page-preview-body">
        <iframe id="livePreviewFrame" src="https://website101305.nicepage.io/Page-6.html?version=28b21c4e-c36b-4ee3-bf19-aca2f0f491d8" width="1057" height="640" style="width:100%;"></iframe>
    </div>
</div>
...
<!---->
<!--	<h1 style="color:deepblue;">MEIC+R Discovery Recovery - Tanking PUTS</h1>-->
<!--	-->
<!--	<hr/> -->
<!--	<br/><br/> -->
<!--	-->
<!--	<a href="https://www.google.com" target="_blank"><h2>Google's HomePage</h2></a>-->
<!--		-->
<!--	<a href="https://www.amazon.com" target="_blank"><h3>Welcome to Amazon</h3></a>-->
<!--	-->
<!--	<a href="page2.html" target="_blank"><h3>GoTo to Page2</h3></a>-->
<!--	<a href="\Users\adeal\OneDrive\Desktop\Cloud\PYTHON\pycodes\HTML1\page3.html"><h3>Link Page3 another Folder</h3></a>-->
<!--	<a href="lists.html" target="_blank"><h3>GoTo Lists</h3></a>-->
<!--	<a href="tables.html"><h3>GoTo Tables</h3></a>-->
<!--	<a href="containers.html" target="_blank"><h3>GoTo Containers </h3></a>-->
<!--	-->
<!--	-->
<!--	-->
<!--	<p><big>This</big> is my <small>paragraph</small></p>-->
<!--	-->
<!--	<p><b>Another paragraph bolded and <i>italicized</i></b></p>-->
<!--	-->
<!--	<p>Water is H<sub>2</sub>0<p>-->
<!--	-->
<!--	<p style="color:red; background-color:yellow">Blue is one of my favorite colors</p>-->
<!--	-->
<!--	<ol> -->
<!--		<li><a href="">Apples</li>-->
<!--		<li>Oranges</li>-->
